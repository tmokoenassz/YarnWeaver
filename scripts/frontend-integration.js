 ...
 * This file demonstrates how to integrate Yarnweaver with a web frontend
 */

// For React/Vue/Angular applications
export class YarnweaverClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new YarnweaverClient(provider, contractAddress);
